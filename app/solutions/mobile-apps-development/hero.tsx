        ...
        <div className="max-w-[760px] text-left">
         ...
         Solutions
          ...
          <p className="mt-7 max-w-[720px] text-[18px] leading-[1.45] text-white sm:text-[20px] lg:text-[25px]">
           Build powerful, user-friendly mobile apps designed to elevate your
            brand, engage your audience, and deliver seamless experiences across
