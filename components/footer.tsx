      ...
      <ul className="mt-6 space-y-4">
        {links.map((link) => (
          <li key={link.label}>
            <Link
              href={link.href}
              className="text-[17px] font-medium text-slate-200/90 transition-colors duration-300 hover:text-cyan-300"
            >
              {link.label}
            </Link>
          </li>
          ...
          return (
            <li key={item.label}>
              <a
                ...
                className="group inline-flex items-center gap-3 text-[17px] font-medium text-slate-200/90 transition-colors duration-300 hover:text-cyan-300"
              >
                <span className="flex h-11 w-11 items-center justify-center rounded-full bg-white/5 text-slate-100 shadow-[0_10px_24px_rgba(0,0,0,0.18),inset_0_1px_0_rgba(255,255,255,0.08)] backdrop-blur-md transition-all duration-300 group-hover:-translate-y-0.5 group-hover:bg-cyan-400/10 group-hover:text-cyan-300">
...
export default function AiverseFooter() {
  ...
  return (
    <footer className="relative overflow-hidden bg-[#03142f] pt-16 text-white sm:pt-20 lg:pt-24">
      <div className="pointer-events-none absolute inset-0">
        <div className="absolute inset-0 bg-[linear-gradient(135deg,#03142f_0%,#041a3f_45%,#062c55_100%)]" />
        <div className="absolute left-[-120px] top-[-40px] h-[320px] w-[320px] rounded-full bg-cyan-400/10 blur-3xl" />
        <div className="absolute bottom-[-120px] left-[12%] h-[280px] w-[280px] rounded-full bg-teal-400/10 blur-3xl" />
        <div className="absolute right-[-80px] top-[20%] h-[340px] w-[340px] rounded-full bg-sky-400/10 blur-3xl" />
        <div className="absolute inset-0 bg-[radial-gradient(circle_at_20%_10%,rgba(34,211,238,0.12),transparent_22%),radial-gradient(circle_at_85%_20%,rgba(56,189,248,0.10),transparent_20%),radial-gradient(circle_at_50%_90%,rgba(45,212,191,0.08),transparent_18%)]" />
        ...
        {[
          ...
          <span
            key={index}
            className="absolute rounded-full bg-cyan-300/60 shadow-[0_0_12px_rgba(34,211,238,0.55)] animate-[footerFloat_10s_ease-in-out_infinite]"
            style={{
              left: star.left,
              top: star.top,
              width: `${star.size}px`,
          ...
          <div className="max-w-[430px] text-left">
            <Link href="/" className="inline-block">
              <img
                src={logoUrl}
                alt="Aiverse logo"
                className="block h-auto w-[110px] object-contain object-left"
              />
            </Link>

            <p className="mt-7 text-[18px] leading-8 text-slate-200/90">
